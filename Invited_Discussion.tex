	...
	\section{Prior specification for BayesCG}
		...
		\begin{figure}
			...
			\begin{subfigure}{0.3\textwidth}
				...
				\label{fig:mat_foil}
			\end{subfigure}
			\caption{Stiffness matrices exhibiting different sparsity and non-zero patterns. The systems described by these matrices are \subref{fig:mat_beam} notched beam; \subref{fig:mat_fan} jet engine compressor fan; \subref{fig:mat_foil} a laminar airfoil.}
			\label{fig:matrices}
		\end{figure}
